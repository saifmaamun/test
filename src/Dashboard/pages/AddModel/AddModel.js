                    ...
                    <div>
                        ...
                        <div className="row">
                            <div className="column">
                                ...
                                <input className="input-field" onBlur={handleModelName} type="text" placeholder='Model Name' required /> <br />

                                <h3>Add Model Description</h3>
                                <input className="input-field" onBlur={handleModelDetails} type="text" placeholder='Model Details' required /><br />
